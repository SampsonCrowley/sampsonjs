      ...
      describe("getters/setters", () => {
        ...
        describe("[list]", () => {
          ...
          it("creates an MDCList of the given element", () => {
            ...
            expect(() => controller.list = null).toThrow(new TypeError("Cannot read property 'dataset' of null"))
            ...
            expect(controller.list.foundation.isSingleSelectionList).toBe(true)
          })
